 ...
 *******************************
    ...
    - Use VM so that CurrentCondition is not directly bound to the WeatherDetails component
 * *****************************
 **/
...
export class Weather {
    ...
    public constructor(currentConditions: CurrentCondition, city: City) {
        ...
        this.temperatureValue = currentConditions.Temperature.Imperial.Value;
        this.temperatureUnit = currentConditions.Temperature.Imperial.Unit;
    }
